    ...
    return (
        <div className='' style={{ backgroundColor: '#242439', height: '100%', width: '100vw' }}>
            ...
            <div className=' mt-5 d-flex justify-content-center pb-5' style={{backgroundColor: '#171725'}} >
                <Card style={{ backgroundColor: '#171725', height: '100%', border:'none' }} className='mx-3 mt-5 p-2  col-xl-5 col-xxl-4 col-lg-6  col-sm-9 col-11'>
                    ...
                    <Card.Text className='s fs-5 col-sm-8 col-12 d-flex  justify-content-start container text-center me-auto mb-3' style={{ color: '#FFFFFF' }}>
                        Subscribed to:  {data2.plan} plan
                    </Card.Text>
                    <Card.Text className='s fs-5 col-sm-8 col-12 d-flex  justify-content-start container text-center me-auto mb-3' style={{ color: '#FFFFFF', wordBreak: 'break-all' }}>Email: {data[1]}</Card.Text>
                    <Card.Text className='s fs-5 col-sm-8 col-12 d-flex  justify-content-start container text-center me-auto mb-3' style={{ color: '#FFFFFF' }}>Bought on: {data[2]}</Card.Text>
                    ...
                    {/* <div className='row d-flex justify-content-between'>
                     ...
                     <div className='row d-flex justify-content-center'>
                        <Link className='col-lg-6 col-sm-8 col-11 my-2' to='/pricing'  style={{ }}> <Button className='fw-bolder fs-4 link d-flex justify-content-center container text-center py-2 mb-1' style={{ color: '#FFFFFF' }} variant="link">Go Pro</Button></Link>
                        <Link className='col-lg-6 col-sm-8 col-11 my-2' to='/paymenthistory' style={{ textDecoration: 'none' }}><Button className='fw-bolder fs-4 rounded-pill  d-flex justify-content-center container text-center py-2 mb-1' style={{ color: '#FFFFFF', backgroundColor: '#242439', borderColor:'#FFFFFF', borderWidth:'2px' }} variant="primary">Payment History</Button></Link>
                    </div>
                </Card>
            </div>

            <div className=' mt-2 d-flex justify-content-center pb-5' >
                <div style={{  height: '100%' }} className='mx-3 mt-5 p-2  col-lg-6 col-11'>
                    ...
                    <div className='row d-flex justify-content-center mb-5'>
                        <Link className='col-sm-6 col-12 my-2' to='/create' style={{ }}> <Button className='fw-bolder fs-4 link d-flex justify-content-center container text-center py-2 mb-1' style={{ color: '#FFFFFF' }} variant="link">Create Chatbot</Button></Link>
                        <Link className='col-sm-6 col-12 my-2' to='/mychatbots' style={{ textDecoration: 'none' }}><Button className='fw-bolder fs-4 rounded-pill  d-flex justify-content-center container text-center py-2 mb-1' style={{ color: '#FFFFFF', backgroundColor: '#242439', borderColor:'#FFFFFF', borderWidth:'2px' }} variant="primary">View Chatbot</Button></Link>
                    </div>
                </div>
            </div>
