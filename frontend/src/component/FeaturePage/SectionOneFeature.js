...
<img src="https://24toolbox.com/assets/image/og/dummy-%C4%ABmage-generator-tool.jpg?ver=220114.01" style={{ width:'100%', height:'100%'}} alt="loading"/>
        </div>
        <div className='col-lg-6 col-12'>
...
<div className='d-flex justify-content-center row'>
    ...
    <Card style={{ backgroundColor: '#212529', border: '1px solid #4A5AB0'  }} className='mx-xxl-2 mx-2 my-3 col-xl-3 col-lg-6 col-sm-8 col-11 d-flex rounded-4'>
