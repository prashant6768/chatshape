    ...
    return (
        <div className='sectionOneGradient' style={{ height: '100%', width: '100vw' }}>
            <div className=' mx-4 ' style={{ paddingTop: '150px', paddingBottom: '100px' }}>
                <h1 className='fw-bolder col-12 d-flex justify-content-center container text-center' style={{ color: '#FFFFFF' }}>Your AI CoPilot to supercharge your business</h1>
                {/* <h4 className='fw-bolder col-12 d-flex justify-content-center container pt-3' style={{ color: '#FFFFFF' }}>Demo</h4> */}
                <p className='fw-bolder col-12 d-flex justify-content-center container py-2  text-center' style={{ color: '#FFFFFF'}}>AI-Powered Business Boost: Empowering Small Businesses and Startups with Streamlined Marketing and Operations, Cutting Effort and Costs!</p>
