    ...
    return (
        <div className='sectionOneGradient' style={{ height: '100%', width: '100vw' }}>
            <div className='   ' style={{ paddingTop: '150px', paddingBottom: '100px' }}>
                ...
                <div className='fw-bolder btn col-lg-5 col-sm-8 col-10 d-flex justify-content-center text-center container   mt-5' style={{ backgroundColor: '#FFFFFF', color: '#FD7930', borderColor: 'white', border: '3px solid white', borderRadius: '20px' }}>
                    <ReactPlayer url={'https://youtu.be/snYu2JUqSWs'} style={{ height: '100vh', width: '100vw' }} loop controls
                        config={{
                            youtube: {
                                playerOptions: {
                                    playsinline: true,
